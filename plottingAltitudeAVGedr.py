...
for algo in ['primary-ratesum','primary-maxmin']:
    ...
    for alt in alt_arr:
        filename = "09-15-2022_"+str(alt)+"000_"+algo+"_0_86399_10_10_10.pkl"   #summmmm:  5297860.741381678
        timestamps = []
        sum_values = []
        ...
        avg_rates.append(s)
    plt.plot(alt_arr, avg_rates, color=colors[algo], alpha=0.6, linewidth=0.7, label=labels[algo])
    plt.scatter(alt_arr, avg_rates, color='r', marker='o')
    plt.ylim(0, 1.4e7)
pdf_filename = "newPlots/edr_vs_alt.pdf"
