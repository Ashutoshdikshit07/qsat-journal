...
for algo in ['primary-ratesum','primary-maxmin']:
    ...
    filename = f"09-15-2022_1000000_{algo}_0_86399_{trl}_{trl}_{trl}.pkl"
    timestamps = []
    sum_values = []
    ...
    plt.plot(timestamps, sum_values, color=colors[algo], alpha=0.6, linewidth=0.7, label=labels[algo])

pdf_filename = f"newPlots/edr_vs_TRL_{trl}.pdf"
pdf_pages = PdfPages(pdf_filename)


plt.title(f"Date=09-15-2022 Alt=1000000 TRL = {trl}", fontsize=16, fontweight='bold', color='darkblue', loc='center', y=1.02, pad=15)

plt.xlabel("timestamp", fontsize=14)
plt.ylabel("AVG EDR", fontsize=14)
