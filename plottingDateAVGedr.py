...
for algo in ['primary-ratesum','primary-maxmin']:
    ...
    dates = ['03-15-2022', '06-15-2022','09-15-2022', '12-15-2022']      # 09/15/2022, '03/15/2022', '06/15/2022', '12/15/2022'
    folder_name = 'dictOP/results/'
    for date in dates:
        filename = date+"_1000000_"+algo+"_0_86399_10_10_10.pkl"
        timestamps = []
        sum_values = []
        ...
        print("algo: ",algo)
        print("date: ",date)
        print("avg_rate: ",avg_rates)
    plt.plot(dates, avg_rates, color=colors[algo], alpha=0.6, linewidth=0.7, label=labels[algo])
    #plt.ylim(0, 1.4e7)
    plt.scatter(dates, avg_rates, color='r', marker='o')
pdf_filename = "newPlots/edr_vs_dates.pdf"
pdf_pages = PdfPages(pdf_filename)


plt.xlabel("Dates", fontsize=14)
plt.ylabel("EDR", fontsize=14)
