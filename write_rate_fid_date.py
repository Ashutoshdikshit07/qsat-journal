...
def solve_assignment(date,alt,algo_type, t_start, t_end, T, R, L):
    ...
    for t in range(t_start, t_end+1, 10):
        ...
        fName = f"dictOP/{tempDate}_{alt}_{algo_type}_{t_start}_{t_end}_{T}_{R}_{L}_maxIter1.pkl"
...
altitudes = [1000000] #, 500000, 1000000, 1500000, 2000000
algos = ["primary-maxmin"]  # "primary-maxmin" , "primary-ratesum"
start_time = 0
end_time = 86399 # Till 86399
